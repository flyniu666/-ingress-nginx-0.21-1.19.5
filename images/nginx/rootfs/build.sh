...
#  mkdir $GEOIP_FOLDER/$1 && tar xf $GEOIP_FOLDER/$1.tar.gz -C $GEOIP_FOLDER/$1 --strip-components 1 && mv $GEOIP_FOLDER/$1/$1.mmdb $GEOIP_FOLDER/$1.mmdb && rm -rf $GEOIP_FOLDER/$1
  wget -O $GEOIP_FOLDER/$1.mmdb $2 || { echo "Could not download $1, exiting." ; exit 1; }
  
}

geoip_get "GeoIPASNum.dat.gz"  "https://mirrors.slackware.com/mb-sources/GeoIP/GeoIPASNum.dat.gz" # "https://src.fedoraproject.org/lookaside/pkgs/GeoIP/GeoIPASNum.dat.gz/f8ed8b468ecee0f7a98cb05c33af7b14/GeoIPASNum.dat.gz"
geoip_get "GeoIP.dat.gz"       "https://mirrors.slackware.com/mb-sources/GeoIP/GeoIP.dat.gz" # "https://src.fedoraproject.org/lookaside/pkgs/GeoIP/GeoIP.dat.gz/508e3c10da15f2722774cf4014863976/GeoIP.dat.gz"
geoip_get "GeoLiteCity.dat.gz" "https://mirrors.slackware.com/mb-sources/GeoIP/GeoLiteCity.dat.gz" #"https://src.fedoraproject.org/lookaside/pkgs/GeoIP/GeoLiteCity.dat.gz/2ec4a73cd879adddf916df479f3581c7/GeoLiteCity.dat.gz"
#geoip2_get "GeoLite2-City"     http://geolite.maxmind.com/download/geoip/database/GeoLite2-City.tar.gz"
geoip2_get "GeoLite2-City"  "https://github.com/zhengkw/GeoLite2/raw/master/GeoLite2-City.mmdb"
geoip2_get "GeoLite2-ASN"   "https://github.com/zhengkw/GeoLite2/raw/master/GeoLite2-ASN.mmdb"   #"http://geolite.maxmind.com/download/geoip/database/GeoLite2-ASN.tar.gz"
